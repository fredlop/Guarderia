...
{
    [DbContext(typeof(GuarderiasDbContext))]
    [Migration("20220910023522_RegistrodeEstrudiantes")]
    partial class RegistrodeAlumnos
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Guarderia.App.Dominio.Alumnos.Alumno", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Guarderia.App.Dominio.Entidades.Alumno", b =>
                {
                    b.HasOne("Guarderia.App.Dominio.Entidades.Alumno", "Alumno")
                        .WithMany()
                        .HasForeignKey("AlumnoId");

                    b.HasOne("Guarderia.App.Dominio.Entidades.Persona", "Persona")
                        .WithMany()
                        .HasForeignKey("PersonaIdI");
